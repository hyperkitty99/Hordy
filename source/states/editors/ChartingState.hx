...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Set Camera Target', "Value 1: Type one to target dad, leave blank to target BF\nValue 2: Type one to force"],
		['Set Cam Speed', "Value 1: Speed\nValue 2: Duration"],
		['Cam Boom Speed', "Value 1: Speed\nValue 2: Intensity"],
		['Cinema bars S', "Value 1: Speed\nValue 2: Intensity"],
