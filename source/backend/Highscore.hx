...
class Highscore {
	...
	public static function saveWeekScore(week:String, score:Int = 0):Void
	{
		...
		weekScores.exists(daWeek) ? if (weekScores.get(daWeek) < score) setWeekScore(daWeek, score) : setWeekScore(daWeek, score);
	}
	...
	public static function formatSong(song:String):String return Paths.formatToSongPath(song);
