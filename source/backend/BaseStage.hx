...
class BaseStage extends FlxBasic
{
	...
	{
		var gfVersion:String = states.PlayState.SONG.gfVersion;
		if(gfVersion == null || gfVersion.length < 1)
		{
			gfVersion = name;
			states.PlayState.SONG.gfVersion = gfVersion;
		}
	}
	...
	public function setStartCallback(myfn:Void->Void)
	{
		...
		states.PlayState.instance.startCallback = myfn;
	}
	public function setEndCallback(myfn:Void->Void)
	{
		if(!onPlayState) return;
		states.PlayState.instance.endCallback = myfn;
	}
