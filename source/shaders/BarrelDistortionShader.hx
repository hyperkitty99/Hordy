...
class BarrelEffect {
	...
	function get_barrelDistortion1() return shader.barrelDistortion1;
	function get_barrelDistortion2() return shader.barrelDistortion2;

	function set_barrelDistortion1(val:Float) return shader.barrelDistortion1 = val;
	function set_barrelDistortion2(val:Float) return shader.barrelDistortion2 = val;
